...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback, View.OnTouchListener {
    ...
    private EditText EdtxFrom, EdtxTo;
    private PlaceAutocompleteFragment mPlaceAutocompleteFragmentFrom, mPlaceAutocompleteFragmentTo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EdtxFrom = (EditText) findViewById(R.id.edtx_from);
        EdtxTo = (EditText) findViewById(R.id.edtx_to);

        mPlaceAutocompleteFragmentFrom = (PlaceAutocompleteFragment)
                getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment_from);


        mPlaceAutocompleteFragmentTo = (PlaceAutocompleteFragment)
                getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment_to);


        ((EditText)mPlaceAutocompleteFragmentFrom.getView().findViewById(R.id.place_autocomplete_search_input)).setText("From Location");
        ((EditText)mPlaceAutocompleteFragmentTo.getView().findViewById(R.id.place_autocomplete_search_input)).setText("To Location");

        /*((EditText)mPlaceAutocompleteFragmentFrom.getView().findViewById(R.id.place_autocomplete_search_input)).setTextSize(7.0f);
        ((EditText)mPlaceAutocompleteFragmentTo.getView().findViewById(R.id.place_autocomplete_search_input)).setTextSize(7.0f);*/

        ((EditText)mPlaceAutocompleteFragmentFrom.getView().findViewById(R.id.place_autocomplete_search_input)).setTextColor(getResources().getColor(R.color.wallet_holo_blue_light));
        ((EditText)mPlaceAutocompleteFragmentTo.getView().findViewById(R.id.place_autocomplete_search_input)).setTextColor(getResources().getColor(R.color.wallet_holo_blue_light));

        mPlaceAutocompleteFragmentFrom.getView().setVisibility(View.INVISIBLE);
        mPlaceAutocompleteFragmentTo.getView().setVisibility(View.INVISIBLE);
        ...
        mPlaceAutocompleteFragmentFrom.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                EdtxFrom.setText(place.getName());
            }
            ...
            public void onClick(View v) {
                ...
                if (nearbyplacesSpinner.getVisibility() == View.INVISIBLE) {
                    ...
                    if (mSupportMapFragment.getView().getLayoutParams().height != sh / 2) {
                        ...
                        EdtxFrom.setVisibility(View.VISIBLE);
                        EdtxTo.setVisibility(View.VISIBLE);
                        mPlaceAutocompleteFragmentFrom.getView().setVisibility(View.VISIBLE);
                        mPlaceAutocompleteFragmentTo.getView().setVisibility(View.VISIBLE);
                        ImgbtnDirections.bringToFront();
                        EdtxFrom.bringToFront();
                        EdtxTo.bringToFront();
                        mPlaceAutocompleteFragmentFrom.getView().bringToFront();
                        mPlaceAutocompleteFragmentTo.getView().bringToFront();
                    }
                    ...
                    EdtxFrom.setVisibility(View.INVISIBLE);
                    EdtxTo.setVisibility(View.INVISIBLE);
                    mPlaceAutocompleteFragmentFrom.getView().setVisibility(View.INVISIBLE);
                    mPlaceAutocompleteFragmentTo.getView().setVisibility(View.INVISIBLE);
